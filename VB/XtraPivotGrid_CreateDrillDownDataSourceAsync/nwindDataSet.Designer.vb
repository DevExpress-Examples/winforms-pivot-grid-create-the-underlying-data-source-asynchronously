    ...
    Partial Public Class nwindDataSet
        ...
        Partial Public Class SalesPersonDataTable
            ...
            Public Function AddSalesPersonRow(ByVal Country As String, ByVal ProductName As String, ByVal CategoryName As String, ByVal Extended_Price As Decimal, ByVal Sales_Person As String) As SalesPersonRow
                ...
                Dim columnValuesArray() As Object = { Country, ProductName, CategoryName, Extended_Price, Sales_Person}
...
Namespace XtraPivotGrid_CreateDrillDownDataSourceAsync.nwindDataSetTableAdapters
    ...
    Partial Public Class SalesPersonTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Country, ProductName, CategoryName, [Extended Price], [Sales Person] FROM " & "SalesPerson"
