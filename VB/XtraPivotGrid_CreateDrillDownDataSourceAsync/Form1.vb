...
Namespace XtraPivotGrid_CreateDrillDownDataSourceAsync
	Partial Public Class Form1
		...
		Public Sub New()
			...
			AddHandler pivotGridControl1.AsyncOperationCompleted, AddressOf PivotGridControl1_AsyncOperationCompleted
		...
		Private Sub PivotGridControl1_AsyncOperationCompleted(ByVal sender As Object, ByVal e As EventArgs)
			'if (dForm != null && dForm.DataSource != null)
			'    dForm.BestFit();
		End Sub
